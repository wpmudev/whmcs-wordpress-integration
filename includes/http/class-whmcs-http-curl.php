...
/**
 * Custom Curl HTTP transport implementation.
 *
 ...
 * @since 1.4.2
 */
class WP_Http_WHMCS_Curl extends WP_Http_Curl
{
	/**
	...
	public function request($url, $args = array()) {
		...
		$r['headers'] = apply_filters('http_curl_headers', $r['headers']); //Custom WHMCS Integration
		...
		// Handle redirects.
		if( apply_filters('http_api_redirect', true)){ //Custom WHMCS Integration
