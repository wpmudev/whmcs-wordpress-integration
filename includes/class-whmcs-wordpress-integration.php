...
class WHMCS_Wordpress_Integration {
	...
	function wp_pointer_load(){
		...
		include WHMCS_INTEGRATION_DIR . 'includes/helpers/class-wp-help-pointers.php';
		$pointers = array(
			array(
	...
	function initialize_widgets(){
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-account-widget.php');
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-content-widget.php');
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-menu-widget.php');
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-quick-navigation-widget.php');
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-sidebar-widget.php');
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-statistics-widget.php');
		include_once(WHMCS_INTEGRATION_DIR . 'includes/widgets/class-whmcs-welcome-widget.php');
